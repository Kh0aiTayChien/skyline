        ...
        <div class="title" style="">
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    ...
                    <div class="icielbegum text-white mt-3 d-flex  d-md-none " style="font-size: 29px">
                        ĐĂNG KÍ NHẬN TƯ VẤN
                    </div>
                </div>
        ...
        <form method="POST" class="" action="" style="letter-spacing: 2px" id="registration-form">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="form-group contact-form mt-3">
                        <label for="contact_email" class="cabin-medium text-white" style="font-size: 13px">EMAIL</label>
                        <br>
